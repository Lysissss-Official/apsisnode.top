	...
	<header id="masthead" class="cryout" <?php cryout_schema_microdata( 'header' ) ?>>
		...
		<div id="header-image-main">
			<div id="header-image-main-inside">
                ...
                <img class="header-image" alt="<?php bloginfo('name'); ?>" src="<?php header_image(); ?>">
                <div id="header-page-title">
                    <div id="header-page-title-inside">
                        <div class="entry-meta pretitle-meta"></div>
                        <!-- .entry-meta -->
                        <h2 class="entry-title" itemprop="headline" style="font-size: 8em;">500</h2>
                        <p class="byline" style="font-size: 1.8em; margin-top: -1.8em; ">Internal Server Error.</p>
